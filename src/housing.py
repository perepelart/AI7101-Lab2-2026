...
LINEAR_GRID = {
    "model__alpha_linear": [0.001, 0.01, 0.1, 1.0, 10.0],
    "model__l1_ratio": [0.0, 0.5, 1.0],
}

SECOND_DEGREE_GRID = {
    "model__alpha_second_degree": [0.001, 0.01, 0.1, 1.0, 10.0],
    "model__l1_ratio": [0.0, 0.5, 1.0],

}

THIRD_DEGREE_GRID = {
    "model__alpha_third_degree": [0.001, 0.01, 0.1, 0.3, 0.5, 0.7, 1.0, 10.0],
    "model__l1_ratio": [0.0, 0.5, 1.0],
